...
# Fix import path - ensure we import HuggingFace datasets, not local
project_root = Path(__file__).parent.parent

# Temporarily rename local datasets from path
local_datasets_path = str(project_root / "datasets")
if local_datasets_path in sys.path:
    sys.path.remove(local_datasets_path)

# Add parent directory to path AFTER removing datasets
sys.path.insert(0, str(project_root))

# Now import - Python will find HuggingFace datasets in site-packages
